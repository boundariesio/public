...
export default () => (
  <>
    ...
    <div className="max-w-full md:max-w-6xl mx-auto my-3 md:px-8 py-8">
              ...
              <div className="bg-white text-black rounded shadow-inner shadow-lg overflow-hidden">
                <div className="block text-left text-sm sm:text-md max-w-sm mx-auto mt-8 text-black px-8 lg:px-6">
                  ...
                  {standard ? (
                    ...
                    <h2 className="text-lg text-gray-700 text-center pb-12">
                ...
                <div className="block flex items-center mt-12 uppercase">
                  <button
