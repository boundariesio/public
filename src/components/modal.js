    ...
    <>
      ...
      >
        <div
          ...
          } animated fadeInUp z-50 shadow-inner max-w-5xl relative align-top m-auto justify-end md:justify-center p-8 bg-white md:rounded w-full md:h-auto md:shadow flex flex-col`}
        >
