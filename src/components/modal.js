    ...
    <>
      ...
      >
        <div
          ...
          } animated fadeInUp shadow-inner max-w-xl md:relative align-top m-auto justify-end md:justify-center p-8 bg-white md:rounded w-full md:h-auto md:shadow flex flex-col`}
        >
          {props.children}
